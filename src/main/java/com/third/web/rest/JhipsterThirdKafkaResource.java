...
@RestController
@RequestMapping("/api/jhipster-third-kafka")
public class JhipsterThirdKafkaResource {

    private final Logger log = LoggerFactory.getLogger(JhipsterThirdKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterThirdKafkaResource(KafkaProperties kafkaProperties) {
